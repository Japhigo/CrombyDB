...
comment on column sec.security_controls.lock_after_failed_attempts is '@DOCBOOK Number of sequential failed logins allowed before a user''s account is locked (Min. 1, Max. 99).';
