...
comment on table sec.controllers_by_system_role is 'Rails controllers available to a System Role.';
comment on column sec.controllers_by_system_role.id is 'Unique identifier for row.';
comment on column sec.controllers_by_system_role.controller_id is 'Foreign key to <link linkend="sec-table-controllers">CONTROLLERS.</link>';
comment on column sec.controllers_by_system_role.system_role_id is 'Foreign key to <link linkend="sec-table-system_roles">SYSTEM_ROLES.</link>';
