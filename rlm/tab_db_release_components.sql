...
create table rlm.db_release_components
  ...
  ,db_component_area_id  int                 not null     references rlm.db_component_areas(id)    
...
comment on column rlm.db_release_components.db_component_area_id is '@DOCBOOK Foreign key to <link linkend="rlm-table-db_component_areas">DB_COMPONENT_AREAS.</link>';
